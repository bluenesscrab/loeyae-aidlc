...
- `get_skill_summary(name)` — 获取指定编码规范摘要（如 `loeyae-crud`、`loeyae-auth`、`loeyae-lowcode-flow`）
...
- 工具与模式：`loeyae-utils`、`loeyae-decide`、`loeyae-optional-util`、`loeyae-test`、`loeyae-framework-modules`、`loeyae-database-design`
