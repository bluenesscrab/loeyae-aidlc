...
条件阈值加载 `common-complexity-assessment.md`，测试范围加载 `common-test-execution-strategy.md`。Loeyae Boot 项目按 `construction-loeyae-compliance.md` 渐进加载 MCP 规范；其他技术栈沿用项目已有规范与通用 steering。
